    ...
    <>
      ...
      <div id="aboutPageContentWrapper">
        ...
        <p className="paragraphsAbout">
          The Delma Island Project is a free web-based platform that presents
          Delma Island’s history, with focus on the 80s to the present.
          Developed by the Dhakira Center for Heritage Studies at New York
          University Abu Dhabi, the Delma Island Project centers around oral
          histories gathered from the island. These stories are presented
          through a map-based, multimedia presentation that allows you to
          explore the island as you navigate through the site.{" "}
        </p>
        ...
        <p className="paragraphsAbout">
          ...
          well as undergraduate student research collaborators. Alia Yunis,
          Professor of Film Studies, and Salama Al Qubaisi of Delma Island
          spearheaded this project. This website was developed and designed by
          Steven Wyks and Junior Francisco Garcia, both are undergraduate
